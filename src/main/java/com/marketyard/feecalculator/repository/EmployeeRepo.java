...
/**
 * Spring Data JPA repository for {@link com.marketyard.feecalculator.entity.Employee} entities.
 * Provides standard CRUD operations and a custom query method to look up employees by their ID.
 */
@Repository
